...
namespace NikosPetShop.Infrastructure.Security
{
    public class AuthenticationHelper : IAuthenticationHelper
    {
        ...
        {
            byte[] hashedPassword = GenerateHash(inputModel.Password, userToValidate.passwordSalt);
            byte[] storedPassword = userToValidate.passwordHash;
